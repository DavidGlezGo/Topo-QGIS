...
class Network2points(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        ...
        """
        return self.tr("Network to Points") 
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterVectorDestination(self.OUTPUT_SHP, self.tr("Network Points")))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        nt.export_point_shp(output_shp)
